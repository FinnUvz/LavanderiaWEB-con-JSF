...
public class PedidoDTO {
    ...
    public String getFechaPedidoFormateada() {
        return (fechaPedido != null) ? fechaPedido.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "";
    }

    public String getFechaEntregaFormateada() {
        return (fechaEntrega != null) ? fechaEntrega.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "";
    }

    public String getHoraEntregaFormateada() {
        return (horaEntrega != null) ? horaEntrega.format(DateTimeFormatter.ofPattern("HH:mm")) : "";
    }

    public String getFechaRecojoFormateada() {
        return (fechaRecojo != null) ? fechaRecojo.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "";
    }

    public String getHoraRecojoFormateada() {
        return (horaRecojo != null) ? horaRecojo.format(DateTimeFormatter.ofPattern("HH:mm")) : "";
    }
